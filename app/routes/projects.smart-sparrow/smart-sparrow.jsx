...
const title = 'Smart Healthcare Locating System';
const description =
  'I worked as the design lead on a major iteration of the Smart Healthcare Locating System. We aimed to create a platform that optimizes the connection between patients, ambulances, and hospitals in emergency healthcare situations.';
const roles = [
  'User Research',
  'UX and UI Design',
  'System Architecture',
...
export const SmartSparrow = () => {
  ...
  <ProjectSectionText>
    In 2025, the Smart Healthcare Locating System project was initiated to build an efficient platform for real-time location tracking of patients, ambulances, and hospitals. The existing systems were fragmented, causing delays and confusion during medical emergencies. The main challenges included improving communication, providing accurate real-time data, and making the system user-friendly for both medical professionals and patients. The primary goal of this project was to reduce emergency response times, facilitate seamless collaboration, and ensure a scalable solution that can handle future healthcare needs.
  </ProjectSectionText>
</ProjectTextRow>
        ...
        <ProjectSection light={isDark}>
          <ProjectSectionContent>
            ...
            <ProjectTextRow>
  <ProjectSectionHeading>Real-time Tracking in the Smart Healthcare Locating System</ProjectSectionHeading>
  <ProjectSectionText>
    One of the core features of the Smart Healthcare Locating System is its real-time tracking capability. This feature allows for precise tracking of ambulances, patients, and hospitals, ensuring quick decision-making during emergencies. 
    Through GPS and location-based technologies, the system provides up-to-the-minute updates on the locations of ambulances, helping dispatch teams identify the nearest available emergency responders to an incident. 
    Additionally, hospitals can track incoming patients, ensuring readiness for treatment upon arrival. This real-time tracking significantly enhances coordination between emergency services, reducing response times and improving patient outcomes.
  </ProjectSectionText>
</ProjectTextRow>
  ...
  <ProjectSectionText>
    To ensure seamless adoption and usability of the Smart Healthcare Locating System, we developed a comprehensive documentation platform. 
    This documentation provides detailed guidelines on system functionalities, including real-time tracking, emergency response coordination, and hospital integration. 
    It serves as a reference for healthcare professionals, ambulance operators, and technical teams, ensuring smooth onboarding and effective utilization of the platform. 
    The documentation also includes troubleshooting steps, API references, and best practices to enhance system efficiency and accessibility.
  </ProjectSectionText>
</ProjectTextRow>
          ...
          >
            <ProjectSectionColumns width="full">
              <ProjectSectionContent width="full">
                ...
                <ProjectSectionHeading>Advantages</ProjectSectionHeading> 
<ProjectSectionText>
  Real-time tracking is a core feature that significantly enhances emergency response efficiency. 
  The system provides live location updates for ambulances, hospitals, and patients, ensuring faster and more accurate dispatching of medical aid. 
  By leveraging GPS and smart algorithms, it reduces response time, improves coordination between healthcare providers, and ensures patients receive timely medical attention. 
  This feature ultimately helps save lives by optimizing resource allocation and minimizing delays in critical situations.
</ProjectSectionText>
...
<ProjectSectionText>
  A key aspect of our system is its ability to adapt dynamically to emergencies. 
  The real-time tracking and intelligent routing system continuously analyze traffic conditions, hospital capacities, and patient locations to optimize emergency response. 
  This adaptability ensures that ambulances take the fastest routes, patients are directed to the nearest available hospitals, and medical resources are allocated efficiently. 
  By enabling healthcare providers to make data-driven decisions on the go, the system enhances responsiveness and improves patient outcomes.
</ProjectSectionText>
